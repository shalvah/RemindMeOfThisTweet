...
const randomReminderMessage = (username, originalTweetId) => {
    let responses = [
    ...
    response += "\n" + "http://twitter.com/i/web/status/" + originalTweetId;
    return response;
};
...
const randomAcknowledgementMessage = (reminderTime, username, originalTweetId) => {
    let responses = [
